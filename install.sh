...
PLUGIN_PATH="/home/${USER}/.local/share/rhythmbox/plugins/looper/"
GLIB_SCHEME="org.gnome.rhythmbox.plugins.looper.gschema.xml"
...
if [[ $RB == false ]]
then
    mv "$PLUGIN_PATH"looper.plugin3 "$PLUGIN_PATH"looper.plugin
fi
